<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
     ...
     <head>
      ...
      <link rel="stylesheet" href="<%=request.getContextPath()%>/resources/css/member_clause.css">
                         ...
                         <td align=center>
                             ...
                             <table>
                                 <tr>
                                     <td>
                                         <div>
                                             <font color="#f67001" size=4>01</font>
                                 ...
                                 <tr>
                                     <td align=center>
                                         <textarea name="tos" rows=15 cols=100 disabled><p>
제1조(목적)
...
제24조(재판권 및 준거법)
 ...
 ②“몰”과 이용자간에 제기된 전자상거래 소송에는 한국법을 적용합니다.
                                 ...
                                 <tr>
                                     <td>
                                         <input type="checkbox" name="agree1">이용약관에 동의합니다.<br><br><br><br>
                                     </td>
                                 </tr>
                                 <tr>
                                     <td>
                                         <div>
                                             <font color="#f67001" size=4>02</font>
                                             <font size=3>개인정보 수집 및 이용에 대한 안내</font>
                                         </div>
                                     </td>
                                 </tr>
                                 <tr>
                                     <td align=center>
                                         <textarea name="tos" rows=15 cols=100 disabled>
수집하는 개인정보의 항목
...
'정보통신망 이용촉진 및 정보보호 등에 관한 법률'의 거래기록 보존 의무에 따른 보존: 1년
                                 ...
                                 <tr>
                                     <td>
                                         <input type="checkbox" name="agree2">개인정보 수집 및 이용에 대한 안내에 동의합니다.
                                     </td>
                                 </tr>
                             </table>
                 ...
                 <br><br>
                     ...
                     <a href="#"> <button type="button" onclick="agree()" class="btn_order" style="margin:10px;">회 원 가 입</button></a>
                     <a href="#"> <button type="button" onClick="location.href='<%=request.getContextPath() %>/view/loginform.jsp'" class="btn_cancel1" style="margin:10px;">취 소 하 기</button></a>
                 ...
                 <table>
                     ...
                     <tr>
                         <td class="foot1">
                             ...
                             <li><a href=#>
                                     <strong>
                                         <font size=3>개인정보처리방침&nbsp;</font>
                                     </strong>
                                 </a>
                             <li><a href=#>
                                     <font size=3>&nbsp;책임의 한계와 법적고지&nbsp;</font>
                                 </a></li>
                             <li><a href=#>
                                     <font size=3>회원정보 고객센터&nbsp;</font>
                                 </a></li>
                         </td>
                     </tr>

                     <address>
                         <td class="foot2"> <img class="image1" src="<%=request.getContextPath() %>/resources/images/kakaologo1.png">
                             <span>kakao Copyright <a href="https://www.kakaocorp.com/" target="_blank">KAKAO Corp.</a> All Rights Reserved.</span>
                         </td>
                     </address>
                 </table>
             </div>
     ...
     <script>
         ...
         /*이용약관 체크박스*/
         function agree() {
             var chbox1 = $("input[name ='agree1']").prop('checked');
             var chbox2 = $("input[name ='agree2']").prop('checked');

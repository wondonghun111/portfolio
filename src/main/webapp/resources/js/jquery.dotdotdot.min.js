...
!function(t, e) {
    ...
    function r(e, n, i, d, l) {
        ...
        return e.contents().detach().each(function() {
            ...
            if (f.is(u))
                ...
                o(i, d) && (s = 3 == h.nodeType ? a(f, n, i, d, l) : r(f, n, i, d, l)),
                s || l && l.detach()
            }
        }),
    ...
    function a(e, n, r, a, d) {
        ...
        b = g.length - 1),
        a.maxLength)
            h = i(h.trim().substr(0, a.maxLength), a),
            l(c, h);
        else {
            for (; m <= b && (0 !== m || 0 !== b); ) {
        ...
        t.fn.dotdotdot = function(e) {
            ...
            a.bind_events = function() {
                return a.bind("update.dot", function(e, d) {
                    ...
                    d instanceof t && (i = d)),
                    g = a.wrapInner('<div class="dotdotdot" />').children(),
                    ...
                    o(g, l) && (u = "children" == l.wrap ? n(g, l, c) : r(g, a, g, l, c)),
                    g.replaceWith(g.contents()),
                    g = null,
                    t.isFunction(l.callback) && l.callback.call(a[0], u, i),
                    s.isTruncated = u,
                    u
                }).bind("isTruncated.dot", function(t, e) {
                    return t.preventDefault(),
                    t.stopPropagation(),
                    "function" == typeof e && e.call(a[0], s.isTruncated),
                    s.isTruncated
                }).bind("originalContent.dot", function(t, e) {
                    return t.preventDefault(),
                    t.stopPropagation(),
                    "function" == typeof e && e.call(a[0], i),
                    i
                }).bind("destroy.dot", function(t) {
                    t.preventDefault(),
                    t.stopPropagation(),
                    a.unwatch().unbind_events().contents().detach().end().append(i).attr("style", a.data("dotdotdot-style") || "").removeClass("is-truncated").data("dotdotdot", !1)
                }),
                a
            }
            ,
            ...
            a.watch = function() {
                ...
                "window" == l.watch) {
                    ...
                    u = setInterval(function() {
                        if (a.is(":visible")) {
                            var t = d(a);
                            c.width == t.width && c.height == t.height || (a.trigger("update.dot"),
                            c = t)
                        }
                    }, 500);
                return a
